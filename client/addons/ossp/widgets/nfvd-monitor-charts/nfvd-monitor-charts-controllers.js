define([
    ...
    function (angular, _, async) {
        'use strict';
        var nfvdMonitorChartsControllers = angular.module('nfvdMonitorChartsControllers', ['commonsEvents', 'dataExchangeServices', 'osspDataAccessServices', 'messageNotifierServices']);
