define([
    ...
    function(angular,_) {
        'use strict';
        var osspCollectorManagerControllers = angular.module('osspCollectorManagerControllers', [ 'commonsEvents','dataExchangeServices','osspDataAccessServices']);
        osspCollectorManagerControllers.controller('osspCollectorManagerController', [
            '$rootScope',
            '$scope',
            '$log',
            '$timeout',
            ...
            function($rootScope, $scope, $log, $timeout,dataExchangeService,dataAccessService,messageNotifierService) {
                var logger = $log.getInstance('osspCollectorManagerControllers');
        ...
        return osspCollectorManagerControllers;
    });
