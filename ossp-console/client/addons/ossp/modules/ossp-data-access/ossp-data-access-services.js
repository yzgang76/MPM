define(
    ...
    function(angular, _, U) {
        ...
        var osspDataAccessServices = angular.module('osspDataAccessServices', ['ui.bootstrap', 'dataExchangeServices', 'datetimeRangeServices']);
        ...
        osspDataAccessServices.service(
            'osspDataAccessService', ['$http',
                '$q',
                '$log',
                'dataExchangeService',
                ...
                function($http, $q, $log, dataExchangeService, datetimeRangeService, $modal, $location, $timeout) {
                    ...
                    var logger = $log.getInstance('osspDataAccessService');
                    ...
                    this.getRouteDeferred = function(route, query, cache, delay) {
                        ...
                        function buildUrl(route, query) {
                            ...
                            logger.info('OSSP dataAccessService: url=', uri);
                            return uri;
                        }
                            ...
                            function(error) {
                                ...
                                if (internalerror && internalerror.statusCode === 403 && internalerror.error === 'Token expired') {
                                    var modalInstance = $modal.open({
                                        templateUrl: 'addons/ossp/modules/ossp-data-access/session-expiration-modal-window.html',
